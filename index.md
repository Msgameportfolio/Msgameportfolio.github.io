...
[1.게임명: 광대](#광대)  
[2.컨셉](#컨셉)  
[3.관련이미지 and 동영상](#관련이미지-and-동영상)  
[4.대표 이미지](#대표-이미지)  
[5.컨셉 and 대표이미지 기반 작품묘사](#컨셉-and-대표이미지-기반)  
[6.광대 게임 구성요소](#광대-게임-구성요소)  
...
시작화면에는 Single play,   Game option라는 버튼 2개가있다.  
...
게임플레이 모습은 총 7개의 시대(고전, 고대, 중세, 르네, 산업, 현대, 미래)를 통해서 발전하는 문명을 그리고 있고 총 2개의 국가(프랑스, 한국)을 통해 운영할수있다.  
...
# 키보드 이벤트에 대한 흐름도  
<iimg src="./img/키보드이벤트1.PNG" width= "50%">

# 용어정리  
<iimg src="./img/용어정리사진.PNG" width= "50%">

# 개발작업 일정(6주)
<iimg src="./img/개발작업일정사진.PNG" width= "50%">
