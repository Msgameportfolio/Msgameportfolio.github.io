...
대표 이미지는 아래의 이미지고 대표로 한 이유는 이미지ui 안에 제가 표현하고 싶은것이 대부분 포함되어있기에 참고ui로 사용하였습니다  

참고ui를 보시게 되면은 상단을 통해서 user가 퀘스트를 통해 획득한 재화를 표시하게되고 하단 ui를 통해서 국가, 어드벤쳐, vr모드, 이벤트, cash샵 등 만들예정입니다  

하나의 국가를 만들고 pvp 경쟁을 하고싶으면 "국가"를 선택해서 이용할수있습니다

내가 좀더 강해지고 싶거나 퀘스트 클리어 조건을 달성하기 위해 

"어드벤쳐" 기능을 이용하면됩니다 

또한 색다른 모드를 즐기고싶으면  "모드"를 선택하여 이용할수있음

 ex) 유저들이 만든 지도맵 , vr맵을 다운로드를 할수있음 
